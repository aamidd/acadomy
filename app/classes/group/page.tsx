...
const articles: Article[] = [
  {
    id: 1,
    title: "کلاس سلفژ گروهی",
    summary: "کلاس هفتگی سلفژ",
    image: "/testimage.jpg?height=200&width=300",
  },
  {
    id: 2,
    title: "تحلیل آثار",
    summary: "تحلیل آثار موسیقایی و هنری به صورت هفتگی و گروهی",
    image: "/testimage.jpg?height=200&width=300",
  }
]
    ...
    <div dir="rtl" className={`flex flex-col min-h-screen ${isDarkMode ? 'bg-[#2E2E2E] text-white' : 'bg-white text-[#2E2E2E]'} font-sans`}>
      ...
      <main className="container mx-auto px-4 py-12 flex-grow">
        <section className="mb-20 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-4 max-w-3xl mx-auto leading-tight">کلاس‌های گروهی</h1>
        </section>
